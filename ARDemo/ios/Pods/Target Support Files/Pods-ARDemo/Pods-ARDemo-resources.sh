...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/GLTFSceneKit/Source/Common/GLTFShaderModifierSurface.shader"
  install_resource "${PODS_ROOT}/GLTFSceneKit/Source/Common/GLTFShaderModifierSurface_alphaModeBlend.shader"
  install_resource "${PODS_ROOT}/GLTFSceneKit/Source/Common/GLTFShaderModifierSurface_doubleSidedWorkaround.shader"
