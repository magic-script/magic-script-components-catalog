...
public class ToastModule extends ReactContextBaseJavaModule {
    ...
    public ToastModule(ReactApplicationContext reactContext) {
        ...
        if (activity != null) {
            ArViewManager.fragmentManager = activity.getSupportFragmentManager();
        }
    ...
    public void show(String message, int duration) {
        ...
        if (activity != null) {
            ArViewManager.fragmentManager = activity.getSupportFragmentManager();
            ArViewManager.beginFragment();
            Toast.makeText(getReactApplicationContext(), "Activity2 exists!", duration).show();
        } else {
