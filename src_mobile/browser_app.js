...
import {
  SceneButton, SceneGridLayout, SceneImage, SceneImageRemote, SceneLine, SceneListView, SceneModel,
  ...
  SceneAlignment, SceneRemote, SceneSpinner, SceneVideo, SceneLinearLayout
} from './test_scenes';
...
class BrowserApp extends React.Component {
  constructor(props) {
    ...
    this.scenes = [
      ...
      { name: 'ListViews', component: <SceneListView /> },
