...
class SceneTextEdit extends React.Component {
  ...
  renderTextEdit({ y, charSpacing, charLimit=0, hint, hintColor=[0.75,0.75,0.75,0.75], lineSpacing, title='', text='', textAlignment='left', textColor, textPadding=[0.0, 0.03, 0.0, 0.03], textSize, multiline=false, password=false, scrolling, weight, style }) {
  ...
  render () {
    return (
      <view localPosition={this.props.localPosition}>
        ...
        {this.renderTextEdit({ y:-0.35, title: 'Additional info', hint: '*optional', textPadding: [0.03, 0.03, 0.03, 0.03], textSize: 0.05, lineSpacing: 2, multiline: true, scrolling: true, weight: 'light', style: 'italic' })}
      </view>
    );
  }
}
